...
C) also in this folder:
 - example_input.fa : example input file
 - out_example.csv : example of output file for example_input.fa
 - all regularly produced files resulting from running code (blast results, hmmer results, vectorized input, temporary files, logs); in detail descriptions are beyond scope of this readme
